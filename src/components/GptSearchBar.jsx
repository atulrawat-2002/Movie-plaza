...
const GptSearchBar = () => {
    ...
    return <>
        <div className="pt-[8%] flex justify-center " >
            <form onSubmit={e => e.preventDefault()} className=" w-1/2 bg-black grid grid-cols-12 opacity-95 ">
                ...
                <button onClick={handleGptSearch} className="m-4 py-2 px-4 bg-red-600 text-black font-semibold rounded-sm col-span-3 cursor-pointer" >Search</button>
            </form>
        </div>
    </>
}
